...
const getEmailHTML = (fullName?: string) => `
      <!DOCTYPE html>
      <html>
        <head>
          <meta charset="utf-8">
          <meta name="viewport" content="width=device-width, initial-scale=1.0">
          <title>Welcome to Play It Loud</title>
        </head>
                  ...
                  <tr>
                    <td style="background-color: #f8f9fa; border-radius: 12px; padding: 40px 30px; border: 1px solid #e9ecef;">
                      ...
                      <p style="margin: 0 0 20px 0; color: #495057; font-size: 16px; line-height: 1.6;">
                        Thank you for joining the Play It Loud waitlist! 🎉
                      </p>
                      
                      <p style="margin: 0 0 20px 0; color: #495057; font-size: 16px; line-height: 1.6;">
                        We're excited to have you on board. You're now part of an exclusive community that's about to experience the future of streaming.
                      </p>
                      
                      <p style="margin: 0 0 30px 0; color: #495057; font-size: 16px; line-height: 1.6;">
                        <strong style="color: #1a0a2e;">What's next?</strong><br>
                        We'll be in touch soon with updates, early access opportunities, and exclusive content. Get ready to binge like a boss! 🚀
                      </p>
                      
                      <div style="text-align: center; margin: 30px 0; padding: 20px; background-color: #fff; border-radius: 8px; border: 2px solid #dc3545;">
                        <p style="margin: 0; color: #dc3545; font-size: 20px; font-weight: bold;">
                  ...
                  <tr>
                    <td align="center" style="padding-top: 30px;">
                      ...
                      <p style="margin: 10px 0 0 0; color: #adb5bd; font-size: 12px;">
                        You're receiving this email because you signed up for the Play It Loud waitlist.
                      </p>
                    </td>
                  </tr>
                </table>
...
export async function POST(request: Request) {
  try {
    ...
    if (!transporter) {
      console.log('Email service not configured. Email would be sent to:', email)
      return NextResponse.json({
        success: true,
    ...
    const info = await transporter.sendMail({
      ...
      to: email,
      subject: 'Welcome to Play It Loud! 🎬',
